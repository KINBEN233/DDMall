...
import com.kinben233.DDMall.service.ProductImageService;
...
public class ProductImageController {
    ...
    public String add(ProductImage pi, HttpSession session,@RequestParam(value = "image",required=false) MultipartFile[] file) {
        for(MultipartFile image:file) {
            UploadedImageFile uploadedImageFile=new UploadedImageFile();
            uploadedImageFile.setImage(image);
