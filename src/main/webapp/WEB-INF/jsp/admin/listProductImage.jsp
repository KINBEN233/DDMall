                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="admin_productImage_add" enctype="multipart/form-data">
                                <table class="addTable">
                                    ...
                                    <tr>
                                        <td>
                                            <input id="filepathSingle" type="file" name="image" multiple/>
                                        </td>
                                    </tr>
                                    <tr class="submitTR">
                                        <td align="center">
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${pisSingle}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a title="点击查看原图" target="_blank" href="img/productSingle/${pi.id}.jpg"><img height="50px" src="img/productSingle/${pi.id}.jpg"></a>
                                </td>
                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormDetail" action="admin_productImage_add" enctype="multipart/form-data">
                                <table class="addTable">
                                    ...
                                    <tr>
                                        <td>
                                            <input id="filepathDetail"  type="file" name="image" multiple/>
                                        </td>
                                    </tr>
                                    <tr class="submitTR">
                                        <td align="center">
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <c:forEach items="${pisDetail}" var="pi">
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a title="点击查看原图" target="_blank" href="img/productDetail/${pi.id}.jpg"><img height="50px" src="img/productDetail/${pi.id}.jpg"></a>
                                </td>
                                <td><a deleteLink="true"
                                       href="admin_productImage_delete?id=${pi.id}"><span
                                        class="glyphicon glyphicon-trash"></span></a></td>
